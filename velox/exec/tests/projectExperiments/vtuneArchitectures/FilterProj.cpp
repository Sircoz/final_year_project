...
int main(int argc, char** argv) {
  ...
  __itt_domain* domainComp = __itt_domain_create("Load"); 
  __itt_string_handle* taskComp = __itt_string_handle_create("Load");
  
  
  folly::init(&argc, &argv, false);

  __itt_task_begin(domainComp, __itt_null, __itt_null, taskComp);
  ProjectPlanArchitectureExperiment demo;
  demo.setup();
  __itt_task_end(domainComp);

  __itt_domain* domain = __itt_domain_create("Exec"); 
