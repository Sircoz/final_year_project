...
class PlanBuilder {
 public:
  ...
  PlanBuilder& filterFromExpr(const core::TypedExprPtr& filterExpr);

  std::pair<PlanBuilder, core::TypedExprPtr> filterCustom(const std::string& filter);
  ...
  const std::vector<core::PlanNodePtr> planList() const {
    return planList_;
  }
 ...
 protected:
  ...
  std::vector<core::PlanNodePtr> planList_;
